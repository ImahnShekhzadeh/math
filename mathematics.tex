...
\begin{document}
	...
	\begin{remark}
		For topological spaces, this does not hold in general. \color{red}TODO.\color{black}
	\end{remark}
	...
	\begin{theorem}
		\color{red}Cf. Proposition 4.27 here (https://www.mileshwheeler.com/ma30252/sec-rel.html)\color{black}
	\end{theorem}
