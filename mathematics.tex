...
\begin{document}
	...
	\begin{exmp}
		Consider the metric space $(\mathbb Q, d)$ with $d(r_1, r_2) := \abs{r_1 - r_2}$ for any $r_1, r_2\in\mathbb Q$. Then the real numbers $(\mathbb R, d_{\text{ext}})$ with $d_{\text{ext}}(\varphi, \psi) := \abs{\varphi - \psi}$ for any $\varphi, \psi\in\mathbb R$ can be constructed as the completion of $(\mathbb Q, d)$ \cite{src:completion_of_Q}.
	\end{exmp}
