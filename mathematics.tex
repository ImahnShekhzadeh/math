...
\begin{document}
	...
	\section{Topological Spaces}
		...
		\begin{exmp}
			The discrete metric from Remark \ref{remark:discrete-metric} induces the discrete topology on $X$ from Example \ref{exmp:discrete_topology}.
		\end{exmp}
		...
		\begin{remark}
			In other words, the preimage of an open set is always open. For topological spaces that are metr^izable, the $\epsilon$-$\delta$ definition of continuity as in Def. \ref{defn:continuity} is equivalent to the preceding definition, cf. Theorem \ref{thrm:preimages_continuous_functions}.
		\end{remark}
