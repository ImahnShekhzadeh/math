...
\begin{document}
	...
	\section{Topological Spaces}
		...
		\begin{exmp}[Metric topology]\label{exmp:metric_topology}
			...
			\end{align} 
			generates the topology $$\tau(\mathscr B) = \{U\subset X\mid \forall x\in U\ \exists B_{r}(x)\in\mathscr B: B_{r}(x)\subset U\},$$
		...
		\begin{proof}
			Let the notation the one from Definition \ref{defn:topological_equivalence_metrics}.
			\\
