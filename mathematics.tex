...
\begin{document}
	...
	\section{Topological Spaces}
		...
		\begin{defn}[Standard topology of $\mathbb R$]
		...
		\begin{remark}
			The trivial topology on $X$ is the coarsest topology, and the discrete topology the finest on $X$.
		\end{remark}
