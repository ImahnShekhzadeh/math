...
\begin{theorem}[Arzel\`a\footnote{\textsc{Cesare Arzel\`a} (1847 -- 1912), Italian mathematician.}-Ascoli\footnote{\textsc{Giulio Ascoli} (1843 -- 1896), Jewish-Italian mathematician.}]
...
\begin{proof}
	...
	\]
	Now define $\delta := \min_{1\leq i\leq n}\{\delta_i\}$, then for all $\epsilon > 0$, $\delta$ satisfies the condition that for all $\varphi_i\in \overline{U}$ and all $x, y\in X$ with $d(x, y) < \delta$, 
	\begin{align*}
		...
		\\ &< 3\epsilon,
	\end{align*}
	which shows that $U$ is also uniformly equicontinuous.
\end{proof}
